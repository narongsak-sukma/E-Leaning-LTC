...
/**
 * Error boundary ระดับ root — PB-4 (DS §5.2 + §9: ข้อความไทยที่ผู้ใช้เข้าใจและบอกทางแก้)
 * ครอบ page ที่อยู่ใต้ root layout โดยตรง (เช่น หน้าแรก) และเส้นทางที่ไม่มี boundary ใกล้กว่า
