...
/**
 * Error boundary ของ route group (admin) — PB-4 (DS §5.2 + §9: ข้อความไทยที่ผู้ใช้เข้าใจและบอกทางแก้)
 * เรนเดอร์ใน Admin Shell (DS §6.3) — แสดงหลังผ่าน session gate ของ layout แล้วเท่านั้น
