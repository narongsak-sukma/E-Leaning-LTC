...
/**
 * Error boundary ของ route group (learner) — PB-4 (DS §5.2 + §9: ข้อความไทยที่ผู้ใช้เข้าใจและบอกทางแก้)
 * เรนเดอร์ใน Learner Shell (DS §6.2) — ผู้เรียนยังเห็นเมนูผู้เรียนและแถบองค์กร
