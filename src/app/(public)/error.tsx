...
/**
 * Error boundary ของ route group (public) — PB-4 (DS §5.2 + §9: ข้อความไทยที่ผู้ใช้เข้าใจและบอกทางแก้)
 * เรนเดอร์ใน Public Shell (DS §6.1) — ผู้ใช้ทั่วไปยังเห็น header/footer ของเว็บไซต์
