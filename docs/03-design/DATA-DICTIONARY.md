...
#### ฟังก์ชันกลไก Identity/License/PDPA/Admin (0035 + 0036 — DCR-11)
...
| `admin_list_users` | SELECT ค้นหา (keyset cursor) — read-only, คนเรียกตรวจสิทธิ์ user:view | roles + audit `PII_ACCESS` ผูกที่ BFF (fail-closed แบบแผน 1.1.2 B7) |
