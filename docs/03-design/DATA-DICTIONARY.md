...
| claimed_at | timestamptz | NULL (lease ของ claim — `claim_data_export_job` ตั้ง ณ ยึดงาน · reclaim สองทาง: เกิน 10 นาที **หรือ IS NULL** (แถว processing ที่ค้างก่อนมี lease ถูก claim ถัดไปยึดกลับ — backfill 0039 §1 · gate p5-r2 B4) ไม่ติด processing ตลอดกาล — B7) |
