...
- **Coverage ตาม RTM must-have: 83 FR นำไปพิสูจน์ได้จริง 79/83** (ผ่าน 74 · ผ่านบางส่วน 5) — อีก 4 รายการคือสิ่งที่ **ไม่มีใน as-built v1** (AUTH-004/005/010 · ASM-012(S)) จดเป็นหนี้ทะเบียนพร้อมเหตุผลที่ §5 — LRN-009 เคยถูกจัด "ไม่มี" ใน 1.0.0/1.0.1 โดยผิด แก้เป็น **ผ่านบางส่วน** ตามหลักฐานโค้ดจริง (§3 — แก้ตาม codex gate p4-r1 M7) — **ไม่มีแถวใดถูกอ้างว่า "ผ่าน" โดยไม่มีหลักฐาน**
...
- ชุดทดสอบที่รันจริงครอบครบทุกฟังก์ชันหลักที่ส่งมอบใน v1 (79/83 FR มีหลักฐาน · 4 รายการไม่มีใน as-built จดเปิด · LRN-009 แก้เป็นผ่านบางส่วนตาม gate p4-r1 M7) และ NFR กลุ่ม security ทั้งหมดมีหลักฐานระดับโค้ด+ชุดทดสอบ
