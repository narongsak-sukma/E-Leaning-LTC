...
| CERT_ISSUE | staff:registrar หรือ ระบบออกอัตโนมัติ (DCR-8: actor ระบบ `00000000-0000-4000-8000-00000000a170` mode='auto') | certificate_id, code, attempt_id, ผู้ออก, **mode: manual/bulk/auto (0026 — bulk = job ของ registrar, auto = cron CRT-008)** | CRITICAL | การสร้างเอกสารเกี่ยวกับบุคคล |
